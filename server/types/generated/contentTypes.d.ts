...
export interface ApiAnaliticAnalitic extends Struct.CollectionTypeSchema {
  collectionName: 'analitics';
  info: {
    displayName: 'analitic';
    pluralName: 'analitics';
    singularName: 'analitic';
  };
  options: {
...
export interface ApiEarningEarning extends Struct.CollectionTypeSchema {
...
export interface ApiJhonJhon extends Struct.CollectionTypeSchema {
  collectionName: 'jhons';
  info: {
    displayName: 'JHON';
    pluralName: 'jhons';
    singularName: 'jhon';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::jhon.jhon'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiQAQA extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::q-a.q-a'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::analitic.analitic': ApiAnaliticAnalitic;
      'api::client.client': ApiClientClient;
      'api::earning.earning': ApiEarningEarning;
